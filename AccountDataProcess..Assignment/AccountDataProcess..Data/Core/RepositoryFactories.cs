...
namespace AccountDataProcess.Data.Core
{
    ...
    {
        private IDictionary<Type, Func<DbContext, object>> GetAccountDataProcessFactories()
        {
            return new Dictionary<Type, Func<DbContext, object>>
                {
                //TODO ad custom repositories here
                    {typeof(IAccountDataRepository), dbContext => new AccountDataRepository(dbContext)},
                };
        }
        ...
        {
            _repositoryFactories = GetAccountDataProcessFactories();
        }
